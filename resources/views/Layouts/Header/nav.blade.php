            ...
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="blogSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" aria-labelledby="blogMegaMenu" style="min-width: 230px;">
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="card-style.html">Card Style</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="listing.html">Listing</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="blog-profile.html">Blog Profile</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="single-article.html">Single Article</a></li>
                </ul>
                <!-- End Submenu -->
              </li>
              <!-- End Blog -->
